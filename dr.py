...
#import cgi
import os
m = input("Local [L], Remote [R], AWS Instance [I], Exit [E]: ")
if m =="L":
	while True:
	...
	os.system("scp -r drorgrem.py root@{}:/".format(ip))
	os.system(r"ssh root@{} python3 /drorgrem.py".format(ip))
elif m =="I":
	ip=("Enter IP Address: ")
	os.system("scp -i hadoopkey.pem -r drorgrem.py ec2-user@{}:~".format(ip))
	os.system("ssh -i hadoopkey.pem -l ec2-user {} sudo python3 drorgrem.py".format(ip))
elif m == "E":
	exit()
else:
	print("can't understand")
